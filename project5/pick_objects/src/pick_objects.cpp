...
int main(int argc, char** argv){
  ...
  // Define a publisher to publish robot location info
  ros::NodeHandle n;
  ros::Publisher robot_pub = n.advertise<std_msgs::String>("/pick_objects/robot_location", 1);
